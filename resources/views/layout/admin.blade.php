            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="{{url('/admin/widgets/widgets')}}" class="nav-link active">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{url('/admin/gallary/add')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add Gallary</p>
                                    </a>
                                    <a href="{{url('/admin/gallary/list')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>List Gallary</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{url('/admin/recipe/add')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add Recipe</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{url('/admin/recipe/list')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>List Recipe</p>
                                    </a>
                                </li>
